...
This application was designed as a way to keep
track of one's Crypto balance from one location.

This application relies on the Coinaprika API 
provided by api.coinaprika.com.
